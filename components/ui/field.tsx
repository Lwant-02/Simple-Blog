...
const FieldError = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement> & { errors?: { message?: string }[] }>(
  ({ className, errors, ...props }, ref) => {
    if (!errors?.length || !errors[0]?.message) return null
    return (
